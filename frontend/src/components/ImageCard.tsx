        ...
        <div className="space-y-2">
          ...
          {onCustomize && (image.processed || image.type === "bg_removed") && image.type !== "thumbnail" && (
            <button
              ...
              className="w-full px-3 py-2 bg-gradient-to-r from-yellow-600 to-orange-600 text-white rounded-md hover:from-yellow-700 hover:to-orange-700 disabled:opacity-50 disabled:cursor-not-allowed text-sm font-medium transition-all duration-200 flex items-center justify-center space-x-2"
            >
